...
{
    11880000,    // 118.800 TWR
    12030000,    // 120.300 APP
    11915000,    // 119.150 APP
    12150000,    // 121.500 EMERG
    12345000     // 123.450 UNICOM
};
...
void SETTINGS_InitEEPROM(void)
{
    ...
    gEeprom.ScreenChannel[0]   = IS_VALID_CHANNEL(Data[0]) ? Data[0] : (FREQ_CHANNEL_FIRST + BAND2_108MHz);
    gEeprom.ScreenChannel[1]   = IS_VALID_CHANNEL(Data[3]) ? Data[3] : (FREQ_CHANNEL_FIRST + BAND2_108MHz);
    ...
    gEeprom.FreqChannel[0]     = IS_FREQ_CHANNEL(Data[2])  ? Data[2] : (FREQ_CHANNEL_FIRST + BAND2_108MHz);
    gEeprom.FreqChannel[1]     = IS_FREQ_CHANNEL(Data[5])  ? Data[5] : (FREQ_CHANNEL_FIRST + BAND2_108MHz);
    ...
    gEeprom.POWER_ON_DISPLAY_MODE        = (Data[7] < 6)              ? Data[7] : POWER_ON_DISPLAY_MODE_MESSAGE;
    // 0EA0..0EA7
...
void SETTINGS_FactoryReset(bool bIsAll)
{
    ...
    if (bIsAll)
    {
        RADIO_InitInfo(gRxVfo, FREQ_CHANNEL_FIRST + BAND2_108MHz, 11880000);
