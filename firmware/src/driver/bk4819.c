...
void BK4819_Init(void)
{
    ...
    // REG_7E: AGC auto + fix index 3 + DC filter bandwidth Rx=4 (narrower for AM noise reduction)
    BK4819_WriteRegister(BK4819_REG_7E, 0x302C);
    ...
    BK4819_WriteRegister(BK4819_REG_48,
        (11u << 12) |     // ??? 0..15
        ( 0u << 10) |     // AF Rx Gain-1
        (46u <<  4) |     // AF Rx Gain-2 (reduced for less noise)
        ( 6u <<  0));     // AF DAC Gain (reduced for less hiss)
